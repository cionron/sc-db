import StringFilterOption from "@/components/string-filter-option";
import { Prisma } from "@prisma/client";

interface props {
  field: string;
  whereInput: Prisma.StringFilter[];
  setWhereInput: any;
}

export default function WhereInputString({
  field,
  whereInput,
  setWhereInput,
}: props) {
  const handleAddWhereString = (input: Prisma.StringFilter) => {
    const nextWhereField: Prisma.StringFilter[] = [input, ...whereInput];
  ...
  return (
    <div>
      <div className="flex justify-center">
        ...
        <StringFilterOption addWhere={handleAddWhereString} />
      </div>
